...
public class BoardControllerTests {
	 ...
	 * "테스트 새글 제목") .param("content", "테스트 새글 내용") .param("writer","user00")
	 ...
	 * .param("bno", "2")) .andReturn() .getModelAndView().getModel()); }
	 */
	/*
	 * 
	 * @Test public void testModify() throws Exception{ String resultPage = mockMvc
	 * .perform(MockMvcRequestBuilders.post("/board/modify") .param("title",
	 * "수정된 테스트 새글 제목") .param("content", "수정된 테스트 새글 내용") .param("writer",
	 ...
	 * "25") ).andReturn().getModelAndView().getViewName(); log.info(resultPage); }
	 * 
	 * 
